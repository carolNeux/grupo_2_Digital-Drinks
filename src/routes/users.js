...
router.post("/login",userValidations.userRegister, usersController.userLogin);
...
router.put("/edit/:id", allowed, userValidations.userRegister, usersController.editStorage);
